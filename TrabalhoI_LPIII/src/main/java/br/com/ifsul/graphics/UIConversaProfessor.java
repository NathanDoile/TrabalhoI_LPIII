...
public class UIConversaProfessor extends JFrame{
	...
	public UIConversaProfessor(CriarTreinadorService service, JFrame telaInicialUI) {
		...
		this.add(proximaConversaButton(conversa, conversaList, service, this, telaInicialUI));
