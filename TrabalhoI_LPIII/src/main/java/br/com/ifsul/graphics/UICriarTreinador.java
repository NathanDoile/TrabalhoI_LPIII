...
public class UICriarTreinador extends JFrame{
	...
	public UICriarTreinador(CriarTreinadorService service, JFrame telaInicial) {
		...
		OKbutton.addActionListener(e -> criarTreinador(service,nameField, telaInicial));
	   ...
	   private void criarTreinador(CriarTreinadorService service, JTextField nameField, JFrame telaInicial) {
